...
export const screens = [
  {
    ...
    gridName: { current: '사용자 목록', improved: '사용자 목록' },
    checkboxHeader: '',
    columns: [
  ...
  },
  {
    ...
    gridName: { current: '유연근무 목록', improved: '유연근무 목록' },
    checkboxHeader: '선택',
    columns: [
      { key: 'sel', header: '선택', type: 'checkbox' },
      { key: 'no', header: '순번' },
  ...
  },
  {
    ...
    note: '2026년 7월 14일 실측에서 확인한 이름 「1행 성명 학생01」, 「1행 서답형(0.0) 편집창」, 「1행 체크박스 행선택 체크박스」를 기준으로 재구성했습니다. 선택형 열의 칸 이름이 옆 열 이름인 「서답형」으로 잘못 합성된 실측 결함을 그대로 재현합니다. 현재 버전의 이 표는 표 이름(aria-label)이 없습니다.',
    ...
    columns: [
      ...
      { key: 'no', header: '번호' },
      { key: 'name', header: '성명' },
      { key: 'choice', header: '선택형(0.0)', type: 'edit', currentHeader: '서답형(0.0)' },
      { key: 'essay', header: '서답형(0.0)', type: 'edit' },
      { key: 'sum', header: '합계' },
    ],
    rows: [
      { no: '1', name: '학생01', choice: '', essay: '', sum: '' },
      { no: '2', name: '학생02', choice: '', essay: '', sum: '' },
      { no: '3', name: '학생03', choice: '', essay: '', sum: '' },
    ],
  },
];
